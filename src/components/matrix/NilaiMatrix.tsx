        ...
        <table className="rekap-matrix-table w-full border-collapse border border-black text-[9px] table-fixed">
          <thead>
            <tr className="bg-slate-200 border-b border-black">
              ...
              <th rowSpan={isPaSplit ? 3 : 2} className="border border-black text-left px-2 align-top font-bold w-48 bg-slate-200 whitespace-nowrap">
                NAMA SISWA
              </th>
              {isPaSplit ? (
            ...
            {records.length === 0 ? (
              ...
              records.map((rec, idx) => (
                <tr key={rec.studentId} className="border-b border-black hover:bg-slate-50 transition-colors">
                  ...
                  <td className="border border-black text-left px-2 font-medium truncate uppercase" title={rec.studentName}>
                    {rec.studentName}
                  </td>
